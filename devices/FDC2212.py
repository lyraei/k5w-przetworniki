...
class FDC2212:
    ...
    def initialize(self):
        ...
        self.bus.write_word_data(self.address, SETTLECOUNT_CH1, 0x100) # odnieść się do datasheet i sprawdzic co sie dzieje
    ...
    def read_capacitance(self) -> float:
        ...
        data_ch1 = self.bus.read_word_data(self.address, DATA_CH1)
        data_lsb_ch1 = self.bus.read_word_data(self.address, DATA_LSB_CH1)
        # if data_ch1 & 1000:
